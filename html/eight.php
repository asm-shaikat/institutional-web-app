...
<html lang="en">
  <head>
    ...
    <title>Eight || Digital Content</title>
    <style>
        .main>div{
            float: left;
        }
  ...
  <body>
    ...
    <h3 style="background-color: cyan; text-align: center; padding: 10px;font-weight: bold;">Class-8 || Education Material</h3>
    <a href="../books/eight/Islam-8 com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">Islamic Education</div></a>
    <a href="../books/eight/Math-8 com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">Math</div></a>
    <a href="../books/eight/Science 8 com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">Science</div></a>
    <a href="../books/eight/Class-8 English Grammar com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">English Grammer</div></a>
    <a href="../books/eight/Eng-8 com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">English For Today</div></a>
    <a href="../books/eight/cls-8 ICT- com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">ICT</div></a>
