...
<html lang="en">
  <head>
    ...
    <title>Seven || Digital Content</title>
    <style>
        .main>div{
            float: left;
        }
  ...
  <body>
    ...
    <div class="main">
    <div class="col-md-7 main-1" style="margin-top: 30px;">
    <h3 style="background-color: cyan; text-align: center; padding: 10px;font-weight: bold;">Class-7 || Education Material</h3>
    <a href="../books/seven/Islam 7 - com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">Islamic Education</div></a>
    <a href="../books/seven/Class 7 bangla bakaron o nirmity- com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">Bangla Grammer</div></a>
    <a href="../books/seven/Class-7 English Grammar- com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">English Grammer</div></a>
    <a href="../books/seven/Class-7 Math -com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">Math</div></a>
    <a href="../books/seven/English -7 com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">English For Today</div></a>
    <a href="../books/seven/Science 7 - com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">Science</div></a>
