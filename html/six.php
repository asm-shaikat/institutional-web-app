...
<html lang="en">
  <head>
    ...
    <title>Six || Digital Content</title>
    <style>
        .main>div{
            float: left;
        }
  ...
  <body>
    ...
    <h3 style="background-color: cyan; text-align: center; padding: 10px;font-weight: bold;">Class-6 || Education Material</h3>
    <a href="../books/six/Islam 6 -com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">Islamic Education</div></a>
    <a href="../books/six/Bangla Bakoron class-6 com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">Bangla Grammer</div></a>
    <a href="../books/six/Class-6 English com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">English For Today</div></a>
    <a href="../books/six/Class-6 Math com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">Math</div></a>
    <a href="../books/six/Class-6 Ananda Path com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">Ananda path</div></a>
    <a href="../books/six/Science-6 com opt.pdf" class="book"><div class="shadow-lg p-3 mb-5 bg-body rounded">Science</div></a>
